...
from application.form import RegistrationForm , Loginform , QuestionForm , AnnouncementForm , DescriptionForm
from application.models import User , Post , Candidate , Vote1 , Vote2 , Candidate2 , Vote3 , Candidate3 ,Announcement , Admin  , SelfDescription
